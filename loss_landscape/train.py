...
def get_dataloader(batch_size, train_size=None, test_size=None, transform_train_data=True, noise_rate=0):
    ...
    if noise_rate:
        ...
        train_dataset = Subset_noisy(train_dataset, indices[:int(train_size*noise_rate)],NUMClass)
...
if __name__ == "__main__":
    ...
    # get dataset
    train_loader, test_loader = get_dataloader(args.batch_size, noise_rate=args.noise_rate)
